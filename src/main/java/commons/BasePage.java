...
public class BasePage {
  ...
  /*  protected void uploadMultipleFiles(WebDriver driver, String... fileNames) {
    ...
    public void clickToHeaderMenuLinkByText(WebDriver driver, String textValue) {
        waitForElementClickable(driver, BasePageUI.DYNAMIC_HEADER_MENU_LINK_BY_TEXT, textValue);
        clickToElement(driver, BasePageUI.DYNAMIC_HEADER_MENU_LINK_BY_TEXT, textValue);
    }

    public void clickToRadioButtonByValue(WebDriver driver, String radioValue) {
        waitForElementClickable(driver, BasePageUI.DYNAMIC_RADIO_BUTTON_BY_VALUE, radioValue);
        clickToElement(driver, BasePageUI.DYNAMIC_RADIO_BUTTON_BY_VALUE, radioValue);
    }

    public void enterToTextBoxByName(WebDriver driver, String nameValue, String inputValue) {
        waitForElementVisible(driver, BasePageUI.DYNAMIC_TEXT_BOX_BY_NAME, nameValue);
        sendKeyToElement(driver, BasePageUI.DYNAMIC_TEXT_BOX_BY_NAME, inputValue, nameValue);
    }

    public void clickToButtonByText(WebDriver driver, String textValue) {
        waitForElementClickable(driver, BasePageUI.DYNAMIC_BUTTON_BY_TEXT, textValue);
        clickToElement(driver, BasePageUI.DYNAMIC_BUTTON_BY_TEXT, textValue);
    }
